    ...
    if (isOpen) {
      if (despesa) {
        reset({
          ...
          valor: despesa.valor,
          data_vencimento: format(parseISO(despesa.data_vencimento), 'yyyy-MM-dd'),
          ...
          <DrawerBody>
            <VStack spacing={4}>
              ...
              <FormControl>
                ...
                <Input {...register('categoria')} placeholder="Ex: MORADIA" textTransform="uppercase" />
              </FormControl>
              ...
              <Collapse in={isRecorrente && !despesa} animateOpacity style={{ width: '100%' }}>
